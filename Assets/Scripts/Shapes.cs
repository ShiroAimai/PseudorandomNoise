...
public static class Shapes
{
    ...
    public struct Plane : IShape {
        ...
        public Point4 GetPoint4 (int i, float resolution, float invResolution) {
            ...
            return new Point4 {
                positions = float4x3(uv.c0, 0f, uv.c1),
    ...
    public struct NaiveSphere : IShape {
        public Point4 GetPoint4 (int i, float resolution, float invResolution) {
            float4x2 uv = IndexTo4UV(i, resolution, invResolution);
            float r = 0.5f;
    ...
    public static float4x2 IndexTo4UV(int i, float res, float invRes)
    {
        float4x2 uv;
        float4 i4 = 4f * i + float4(0f, 1f, 2f, 3f);
        
        uv.c1 = floor(invRes * i4 + 0.00001f);
        uv.c0 = invRes * (i4 - res * uv.c1 + 0.5f);
        uv.c1 = invRes * (uv.c1 + 0.5f);
